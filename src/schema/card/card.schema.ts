...
const CardSchema = z.object({
	...
	cardTraderEtchedUrl: z.url().nullish(),
	cardTraderFoilUrl: z.url().nullish(),
	cardTraderUrl: z.url().nullish(),
	cmc: z.number(),
	cn: z.string(),
	...
	starcitygames_etched_url: z.url().nullish(),
	starcitygames_foil_sku: z.string().nullish(),
	starcitygames_foil_url: z.url().nullish(),
	starcitygames_sku: z.string().nullish(),
	starcitygames_url: z.url().nullish(),
...
export default testStrict(CardSchema);
